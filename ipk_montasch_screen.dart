...
class _IPKMontaschScreenState extends State<IPKMontaschScreen> {
  ...
  Future<void> _confirmDelete(String docId) async {
    ...
    if (yes == true) {
      await FirebaseFirestore.instance.collection('IPKMontasch').doc(docId).delete();
          ...
          children: [
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance.collection('IPKMontasch').orderBy('orderNumber').snapshots(),
                        ...
                        child: ListTile(
                          ...
                          subtitle: Column(
                            ...
                            children: [
                              ...
                              Text('Заданий: ${tasks.length}', style: TextStyle(fontFamily: 'GolosR', color: Colors.grey[600], fontSize: 14 * scale)),
                              if (data['createdAt'] != null) ...[
                                SizedBox(height: 4 * scale),
                                Text('Создан: ${_formatDate(data['createdAt'])}', style: TextStyle(fontFamily: 'GolosR', fontSize: 12 * scale, color: Colors.grey)),
                              ],
                            ],
                          ),
