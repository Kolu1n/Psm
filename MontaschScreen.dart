  ...
  Future<void> _confirmDelete(BuildContext context, String docId) async {
    ...
    final shouldDelete = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text(
          'Удаление заказа',
          style: TextStyle(fontFamily: 'GolosB', fontSize: 19),
        ),
        content: Text(
        ...
        actions: [
          TextButton(
            child: Text(
              'Отмена',
              style: TextStyle(color: Colors.grey, fontFamily: 'GolosR'),
            ),
          ...
          TextButton(
            child: Text(
              'Да',
              style: TextStyle(color: Colors.red, fontFamily: 'GolosB'),
            ),
